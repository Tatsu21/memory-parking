...
// Aici se formeaza casetele text
    ColumnLayout {
            ...
            TextField {
                id: singleline1
                placeholderText: qsTr("default: 750")
                text: ""
            ...
            TextField {
                id: singleline3
                placeholderText: qsTr("default: 1")
                text: ""
                Layout.alignment: Qt.AlignTop
                Layout.margins: 5
                background: Rectangle {
            ...
            TextField {
                id: singleline4
                placeholderText: qsTr("default: 64")
                text: ""
                Layout.alignment: Qt.AlignTop
                Layout.margins: 5
                background: Rectangle {
            ...
            TextField {
                id: singleline6
                placeholderText: qsTr("default: 0.0012f")
                text: ""
                Layout.alignment: Qt.AlignTop
                Layout.margins: 5
                background: Rectangle {
            ...
            TextField {
                id: singleline7
                placeholderText: qsTr("default: 5")
                text: ""
                Layout.alignment: Qt.AlignTop
                Layout.margins: 5
                background: Rectangle {
