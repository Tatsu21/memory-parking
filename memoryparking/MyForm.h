...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bRUTEFORCEToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::bRUTEFORCEToolStripMenuItem_Click);
			// 
			...
			this->fLANNToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::fLANNToolStripMenuItem_Click);
			// 
			// menuStrip1
			// 
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(80, 418);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(197, 418);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(312, 418);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(429, 418);
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(544, 418);
			...
			this->label3->Location = System::Drawing::Point(77, 402);
			...
			this->label4->Location = System::Drawing::Point(194, 402);
			...
			this->label5->Location = System::Drawing::Point(309, 402);
			...
			this->label6->Location = System::Drawing::Point(426, 402);
			...
			this->label7->Location = System::Drawing::Point(541, 402);
			...
			this->label8->Location = System::Drawing::Point(9, 465);
			...
			this->label10->Location = System::Drawing::Point(756, 465);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (openFileDialog2->ShowDialog() == System::Windows::Forms::DialogResult::OK)
		{
			...
			{
				listView1->Items->Add(openFileDialog2->FileNames[i]);
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (featureSelect == 1)
		{
			...
			label10->Text = "ruleazaaaaa";
			std::vector<std::string> images;
			for (int i = 0; i < listView1->VirtualListSize; i++)
			{
				images.push_back(msclr::interop::marshal_as<std::string>(listView1->GetItemRect(i).ToString()));
			}
			mp::Functions a;
			a.startAkaze(msclr::interop::marshal_as<std::string>(pictureBox1->ImageLocation->ToString()), images, descSize, descChan, thresh, nOct, nOctL, matchingSelect);
	...
	private: System::Void bRUTEFORCEToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		label8->Text = "BRUTEFORCE";
		matchingSelect = 1;
	}
private: System::Void label8_Click(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void fLANNToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	label8->Text = "FLANN";
	matchingSelect = 2;
}
